...
public class FivbNetworkService {
  ...
  public static Observable<List<BeachTournament>> requestTournaments(String parameter) {
    createRetrofit();
    return retrofit.create(FivbServiceApi.class).requestTournaments(parameter)
        .map(TournamentsResponses::getTournaments);
  }
}
